...
export default class Command extends BaseCommand {
	...
	run = async (
		...
		const gifs = [
			...
			"https://c.tenor.com/oYY7PjPTTXoAAAPo/nino-nakano-the-quintessential-quintuplets.mp4",
			"https://c.tenor.com/nhn1HnCIuiYAAAPo/nino-nakano-nino.mp4",
		];
